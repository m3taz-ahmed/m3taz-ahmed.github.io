const en = {
  seo: {
    ...
    description:
      'Portfolio of Moataz Ahmed, a seasoned software engineer with 15+ years experience. Expert in Laravel 13, Filament v5, Sovereign AI Architecture, and audit-ready system design.',
    author: 'Moataz Ahmed',
    ...
    items: [
      {
        ...
        desc: 'Engineered a high-traffic system with 99.9% uptime during peak hours.',
        metric: '28K+ Bookings',
        icon: 'Ticket',
      ...
      },
      {
        ...
        desc: 'Transformed traditional marina docking into a fully automated digital workflow.',
        metric: 'Automation',
        icon: 'Anchor',
      ...
      },
      {
        ...
        desc: 'Built a high-flexibility survey engine with automated reporting.',
        metric: 'Laravel 13',
        icon: 'ChartBar',
      ...
      },
      {
        ...
        desc: 'Notification architecture and real-time appointment booking system.',
        metric: '+35% Bookings',
        icon: 'Smartphone',
    ...
    categories: [
      {
        ...
        tags: [
          { label: 'PHP 8.5', info: '15+ years of core logic development', level: 'expert' },
          { label: 'Laravel 13', info: 'Deep architectural expertise', level: 'expert' },
          { label: 'Node.js 24', info: 'Real-time orchestration', level: 'advanced' },
      ...
      },
      {
        title: 'Admin & UX',
        tags: [
          { label: 'Filament v5', info: 'Lead developer grade', level: 'expert' },
          { label: 'Livewire', info: 'Reactive UI building', level: 'expert' },
          { label: 'Alpine.js', info: 'Client-side micro-interactions', level: 'advanced' },
          { label: 'Tailwind v4', info: 'Modern utility-first styling', level: 'expert' },
        ],
      },
      {
        title: 'Data & Systems',
        tags: [
          ...
          { label: 'SOLID Principles', info: 'Strong foundational design', level: 'expert' },
